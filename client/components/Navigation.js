...
export const CustomPrevButton = (props) => {
  ...
  return <h3 style={{cursor: 'pointer', display: 'inline-block', marginRight: 24, marginTop: 0}} onClick={handlePrevClick}>Previous page</h3>;
};
...
export const CustomNextButton = (props) => {
  ...
  return <h3 style={{cursor: 'pointer', display: 'inline-block', marginLeft: 24, marginTop: 0}} onClick={handleNextClick}>Next page</h3>;
};
...
export const CustomPages = (props) => {
  ...
  return <h3 style={{display: 'inline-block', marginTop: 0}}>Page {page} from {pages}</h3>;
};
